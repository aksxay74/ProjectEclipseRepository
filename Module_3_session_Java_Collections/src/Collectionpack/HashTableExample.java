...
bookId = scan.nextInt();
//use scan.nextLine(); to remove the left over the newline character in//This clears the buffer, allowing the subsequent nextLine() method to

scan.nextLine();
// or
// bookId=Integer.parseInt(scan.nextLine()); // remove the cursor after
...
System.out.println(book.bookName + " " + book.authorName + " " +
book.bookPrice);
}
